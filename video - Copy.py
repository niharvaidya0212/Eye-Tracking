...
lb1=Label(top,width=48,height=1,font=('Brush script std',20,'bold'),text="Video",bd=10,bg='#EFE2BA',fg='#F13C20')
lb1.place(x=0,y=0)

lb1=Label(f1,font=('Brush script std',23,'underline'),text="Morse code Image : ",bd=10,bg='#eeeeee',fg='black')
...
lb2=Label(f1,font=('Brush script std',23,'underline'),text="Run the morse code program : ",bd=10,bg='#eeeeee',fg='black')
#lb2.grid(row=3,column=0)
lb2.place(x=100,y=280)

T=Entry(f1,font=('arial',12,'bold'),bd=2,width=40)
T.place(x=200,y=410)
